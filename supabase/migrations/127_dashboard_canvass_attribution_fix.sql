-- Dashboard canvass reporting should credit the frozen canvass attribution first.
-- owner_user_id can change as leads move through the pipeline; pin_attributed_user_id
-- preserves the original canvass rep for reporting.
