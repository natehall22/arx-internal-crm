...
export function seedReportDoc(prefill: SeedPrefill = {}): ReportDoc {
  return {
    ...
    guide: { include: true },
    sections: [
      { id: uid(), dividerTitle: 'OVERVIEW', dividerSubtitle: '', headerLabel: 'OVERVIEW', photoIds: [] },
      { id: uid(), dividerTitle: 'FRONT', dividerSubtitle: '', headerLabel: 'FRONT', photoIds: [] },
      { id: uid(), dividerTitle: 'BACK', dividerSubtitle: '', headerLabel: 'BACK', photoIds: [] },
      { id: uid(), dividerTitle: 'LEFT SIDE', dividerSubtitle: '', headerLabel: 'LEFT SIDE', photoIds: [] },
      { id: uid(), dividerTitle: 'RIGHT SIDE', dividerSubtitle: '', headerLabel: 'RIGHT SIDE', photoIds: [] },
    ],
    captions: {},
    rotations: {},
    unsorted: [],
