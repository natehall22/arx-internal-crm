...
export const EMPLOYEE_AGREEMENT_TEMPLATES: Record<EmployeeAgreementKey, EmployeeAgreementTemplate> = {
  field_marketer: {
    ...
    sections: [...fmOpening('Field Marketer'),
      { heading: '5. Compensation Structure', paragraphs: ['The Field Marketer receives whichever is greater for each workweek: eligible $500 weekly performance pay or 3% of attributed commissionable sale value. The two amounts are not added together.', 'The $500 weekly performance pay is eligible only when the Company’s documented weekly performance requirements are completed and verified. Commission is earned only when a job is sold, installed, fully paid, and verified as attributed to the Field Marketer.', 'Attribution and completed performance requirements are determined from the Company’s verified CRM records. Commissionable sale value means the contract value recorded in the CRM after applicable cancellations, insurance denials, reductions, chargebacks, or other documented adjustments.'] },
