...
export default async function AdminPage() {
  ...
  const adminSections = [
    ...
    {
      title: 'Sisu — Heats & Badges',
      description: 'Manage performance Heats, Sisu cycles, and achievement badges',
    ...
    {
      title: '444 Program',
      description: 'Enroll new field marketers in the 444 guarantee — 400 doors, 4 inspections, $400/week',
      href: '/admin/sisu/444',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'FM Accountability',
      description: 'Live view of every setter and field marketer — doors knocked, inspections set, 444 status',
      href: '/admin/sisu/accountability',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
