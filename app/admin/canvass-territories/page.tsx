    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-6 flex flex-wrap items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">Canvass work areas</h1>
          <p className="text-sm text-gray-600 w-full md:w-auto">
            Draw polygons and assign reps. Set each rep&apos;s{' '}
            <strong>Canvass Map Pin Visibility</strong> to <strong>Territory</strong> on the Users page so they only
            see pins inside their assigned areas.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8">
              <div className="bg-white rounded-lg shadow overflow-hidden h-[560px] relative">
                {!ready && (
