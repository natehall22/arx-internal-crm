        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Sub Contractor Portal</p>
            </div>
            <Link
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <p className="font-medium text-gray-900 mt-1">{job.customer_name || 'Customer'}</p>
                    </div>
                  ...
                  {job.scheduled_date && (
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      {job.estimated_duration_hours && (
                        <span className="text-gray-500">{job.estimated_duration_hours}h est.</span>
                      )}
                    </div>
                  )}
