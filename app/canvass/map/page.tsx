              ...
              {mapStatus === 'loaded' && (
                <>
                  ...
                  <button
                    ...
                    className="absolute right-4 bottom-[70px] lg:bottom-4 w-14 h-14 bg-indigo-600 rounded-full shadow-xl flex items-center justify-center text-white active:bg-indigo-700 transition-transform active:scale-95 border-2 border-white z-20"
                  ...
                  <div className="absolute right-4 bottom-[140px] lg:bottom-20 z-20">
                    <button
