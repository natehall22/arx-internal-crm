  ...
  try {
    ...
    const { data: measurement, error: measurementError } = await adminClient
      ...
      .insert({
        ...
        drip_edge_lf: measurements.drip_edge_lf ?? null,
        step_flashing_lf: measurements.step_flashing_lf ?? null,
        penetration_count: measurements.penetration_count ?? null,
        chimney_count: measurements.chimney_count ?? null,
        skylight_count: measurements.skylight_count ?? null,
